...
import (
	...
	"github.com/gk/go-serverless-stack/pkg/validators"
)
...
var (
	...
	ErrorCouldNotBynamoPutItem   = "could not dynamo put item"
...
func CreateUser(req events.APIGatewayProxyRequest, tablename string, dynaClient dynamodbiface.DynamoDBAPI) (*User, error) {
	...
	if !validators.IsEmailVerified(u.Email) {
	...
	if err != nil {
		return nil, errors.New(ErrorCouldNotBynamoPutItem)
	}
	return &u, nil
}
